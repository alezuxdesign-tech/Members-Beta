...
class Estudiantes extends Module_Base {
	...
	public function register_assets() {
		// Estilos
		// Estilos
		\wp_enqueue_style( 'alezux-estudiantes-css', \plugin_dir_url( __FILE__ ) . 'assets/css/estudiantes.css', [], '1.3.4' );
		...
		// Scripts
		\wp_enqueue_script( 'alezux-estudiantes-js', \plugin_dir_url( __FILE__ ) . 'assets/js/estudiantes.js', [ 'jquery' ], '1.3.2', true );
