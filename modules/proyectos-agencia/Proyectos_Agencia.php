...
class Proyectos_Agencia extends Module_Base {
    ...
    public function enqueue_scripts() {
        // CSS
        wp_register_style( 'alezux-kanban-css', ALEZUX_PROYECTOS_AGENCIA_URL . 'assets/css/kanban.css', [], '1.0.0' );
        wp_register_style( 'alezux-client-view-css', ALEZUX_PROYECTOS_AGENCIA_URL . 'assets/css/client-view.css', [], '1.0.0' );
        
        // JS - Admin
        wp_register_script( 'alezux-kanban-js', ALEZUX_PROYECTOS_AGENCIA_URL . 'assets/js/kanban-app.js', ['jquery', 'jquery-ui-sortable'], '1.0.0', true );
        ...
        // JS - Client
         wp_register_script( 'alezux-client-app-js', ALEZUX_PROYECTOS_AGENCIA_URL . 'assets/js/client-app.js', ['jquery'], '1.0.0', true );
